...
Navigation.setLazyComponentRegistrator((screenName) => {
    ...
    switch (screenName) {
        ...
        case Screens.CHANNEL_INFO:
            ...
            break;
        case Screens.CHANNEL_READERS:
            screen = withServerDatabase(require('@screens/channel_readers').default);
            break;
        case Screens.CODE:
        ...
        case Screens.POST_PRIORITY_PICKER:
            ...
            break;
        case Screens.POST_READERS:
            screen = withServerDatabase(require('@screens/post_readers').default);
            break;
        ...
        case Screens.SETTINGS_DISPLAY_CRT:
            ...
            break;
        case Screens.SETTINGS_DISPLAY_EMOTICONS:
            screen = withServerDatabase(require('@screens/settings/display_emoticons').default);
            break;
