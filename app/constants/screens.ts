...
export const CHANNEL_READERS = 'ChannelReaders';
...
export const SETTINGS_DISPLAY_EMOTICONS = 'SettingsDisplayEmoticons';
...
export const SETTINGS_HAPTIC_FEEDBACK = 'SettingsHapticFeedback';
